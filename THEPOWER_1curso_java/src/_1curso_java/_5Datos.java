...
import java.util.Scanner; // Hemos importado la librería Scanner

/**
 * Clase de ejemplo para la entrada de datos con Scanner
 * @author jdavi
 */
public class _5Datos {
    public static void main(String[] args) {
        ...
        System.out.print("Por favor ingrese un numero float;");
        ...
        System.out.print("Esto suma mi numero entero y mi numero decimal:" + (numeroUsuario + numeroDecimal));// Cerrar el Scanner (buena práctica)
        entrada.close();
    }
}
